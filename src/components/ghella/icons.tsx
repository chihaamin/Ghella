 ...
 * being approximated by an icon set.
 */

type Icon = SVGProps<SVGSVGElement> & { size?: number }

function Svg({ size = 24, children, ...props }: Icon) {
  return (
...
export function GhellaLogo({ className }: { className?: string }) {
  return (
    <svg width="92" height="26" viewBox="0 0 240 64" className={className} aria-label="Ghella">
      <text
        x="0"
        y="46"
        style={{ font: "700 52px 'Space Grotesk',sans-serif", letterSpacing: "-2px" }}
        fill="#2f4520"
      >
        ghella
      </text>
...
export function BellIcon({ size = 17, stroke = C.ink }: Icon & { stroke?: string }) {
  return (
    <Svg size={size} fill="none" stroke={stroke} strokeWidth={2}>
      <path d="M18 8a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9M10.3 21a2 2 0 0 0 3.4 0" />
    </Svg>
  )
}

export function OfflineIcon({ size = 13 }: Icon) {
  return (
    <Svg size={size} fill="none" stroke={C.sun} strokeWidth={2.6}>
      <path d="M1 1l22 22M9 9a10 10 0 0 1 13 3M5 12a14 14 0 0 1 3-2.5M8.5 15.5a6 6 0 0 1 5-1.8M12 19h.01" />
    </Svg>
  )
}

export function SunIcon({ size = 18 }: Icon) {
  return (
    <Svg size={size} fill="none" stroke={C.sun} strokeWidth={2.4}>
...
export function CloudIcon({ size = 18 }: Icon) {
  return (
    <Svg size={size} fill={C.sand}>
      <path d="M6 19a5 5 0 1 1 1-9.9A7 7 0 0 1 20.5 11 4 4 0 0 1 19 19Z" />
    </Svg>
  )
}

export function RainIcon({ size = 18 }: Icon) {
  return (
    <Svg size={size}>
...
export function FrostIcon({ size = 18 }: Icon) {
  return (
    <Svg size={size} fill="none" stroke={C.waterDeep} strokeWidth={2.2}>
...
export function WarningIcon({
  ...
  return (
    <Svg size={size} fill="none" stroke={stroke} strokeWidth={strokeWidth}>
      <path d="M12 3l10 18H2Z M12 10v5M12 18.5v.01" />
    </Svg>
  )
}

export function LockIcon({ size = 14, stroke = C.clay }: Icon & { stroke?: string }) {
  return (
    <Svg size={size} fill="none" stroke={stroke} strokeWidth={2.4}>
...
export function CheckIcon({ size = 12, stroke = "#fff", strokeWidth = 3 }: Icon & { stroke?: string }) {
  return (
    <Svg size={size} fill="none" stroke={stroke} strokeWidth={strokeWidth}>
...
export function PinIcon({ size = 26, stroke = C.leafDeep }: Icon & { stroke?: string }) {
  return (
    <Svg size={size} fill="none" stroke={stroke} strokeWidth={2.2}>
...
export function ClockIcon({ size = 17, stroke = C.sunInk }: Icon & { stroke?: string }) {
  return (
    <Svg size={size} fill="none" stroke={stroke} strokeWidth={2.2}>
...
export function WaterDrop({ size = 15, fill = C.water }: Icon & { fill?: string }) {
  return (
...
export function LeafGlyph({ size = 30, fill = "#7a9a5e" }: Icon & { fill?: string }) {
  return (
